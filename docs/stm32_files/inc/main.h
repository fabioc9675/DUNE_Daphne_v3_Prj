...
#define OSC32I_Pin GPIO_PIN_14
#define OSC32I_GPIO_Port GPIOC
#define OSC32O_Pin GPIO_PIN_15
#define OSC32O_GPIO_Port GPIOC
...
#define SS_SCK_Pin GPIO_PIN_5
#define SS_SCK_GPIO_Port GPIOA
...
#define SPIFRamCS_Pin GPIO_PIN_0
#define SPIFRamCS_GPIO_Port GPIOD
...
#define SS_MOSI_Pin GPIO_PIN_7
#define SS_MOSI_GPIO_Port GPIOD
...
#define CM_PGA_CSn_Pin GPIO_PIN_5
#define CM_PGA_CSn_GPIO_Port GPIOI
#define CM_ADC_CSn_Pin GPIO_PIN_6
#define CM_ADC_CSn_GPIO_Port GPIOI
#define CM_ADC_DRDY_Pin GPIO_PIN_7
#define CM_ADC_DRDY_GPIO_Port GPIOI
