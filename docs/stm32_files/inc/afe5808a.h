...
/* ADC Bit Mnemonics ---------------------------------------------------------*/
// REG0
__extension__ typedef struct tagREG00BITS {
	union {
		struct {
...
// REG01
__extension__ typedef struct tagREG01BITS {
	union {
		struct {
...
// REG02
__extension__ typedef struct tagREG02BITS {
	union {
		struct {
			uint16_t :3;
...
// REG03
__extension__ typedef struct tagREG03BITS {
	union {
		struct {
...
// REG04
__extension__ typedef struct tagREG04BITS {
	union {
		struct {
			uint16_t :1;
...
// REG05
__extension__ typedef struct tagREG05BITS {
	union {
		struct {
...
/* VCA Bit Mnemonics ---------------------------------------------------------*/
// REG50
__extension__ typedef struct tagREG50BITS {
	union {
		struct {
			uint16_t :10;
...
// REG51
__extension__ typedef struct tagREG51BITS {
	union {
		struct {
			uint16_t :1;
...
// REG52
__extension__ typedef struct tagREG52BITS {
	union {
		struct {
...
// REG53
__extension__ typedef struct tagREG53BITS {
	union {
		struct {
			uint16_t PDN_CH :8;
			uint16_t :2;
...
// REG54
__extension__ typedef struct tagREG54BITS {
	union {
		struct {
...
// REG55
__extension__ typedef struct tagREG55BITS {
	union {
		struct {
...
// REG56
__extension__ typedef struct tagREG56BITS {
	union {
		struct {
...
// REG57
__extension__ typedef struct tagREG57BITS {
	union {
		struct {
...
// REG59
__extension__ typedef struct tagREG59BITS {
	union {
		struct {
			uint16_t :2;
			uint16_t HPF_LNA :2;
