...
//--------------------------------------------------------------------------------
//Command: generate_target bd_5ac1.bd
//Design : bd_5ac1
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_5ac1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_5ac1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=43,numReposBlks=33,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "kria_bd_axi_smc_0.hwdef" *) 
module bd_5ac1
   (M00_AXI_awaddr,
    M00_AXI_awburst,
    M00_AXI_awcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 S01_AXI AWADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME S01_AXI, ADDR_WIDTH 32, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN kria_bd_clk_wiz_0_0_clk_out1, DATA_WIDTH 32, FREQ_HZ 199998000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 1, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 0, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 16, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE WRITE_ONLY, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) input [31:0]S01_AXI_awaddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI:S02_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN kria_bd_clk_wiz_0_0_clk_out1, FREQ_HZ 199998000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  ...
  m00_exit_pipeline_imp_IKQ3CR m00_exit_pipeline
  ...
  m00_nodes_imp_57LBVB m00_nodes
  ...
  s00_entry_pipeline_imp_1HSDOXK s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_1MXFL9E s00_nodes
  ...
  s01_entry_pipeline_imp_P5KCKS s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_KDGPP0 s01_nodes
  ...
  s02_entry_pipeline_imp_CAJ5HT s02_entry_pipeline
       (.aclk(aclk_3),
        .aresetn(aresetn_4),
  ...
  s02_nodes_imp_EPWFDB s02_nodes
  ...
  switchboards_imp_1H5OJ1Y switchboards
       (.M00_SC_AR_recv(1'b0),
...
module m00_exit_pipeline_imp_IKQ3CR
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awburst,
...
module s00_entry_pipeline_imp_1HSDOXK
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_5ac1_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_5ac1_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_5ac1_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s01_entry_pipeline_imp_P5KCKS
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_5ac1_s01mmu_0 s01_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_5ac1_s01sic_0 s01_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_5ac1_s01tr_0 s01_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s02_entry_pipeline_imp_CAJ5HT
   (aclk,
    aresetn,
    m_axi_awaddr,
    m_axi_awcache,
  ...
  bd_5ac1_s02mmu_0 s02_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_5ac1_s02sic_0 s02_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_5ac1_s02tr_0 s02_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_1H5OJ1Y
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
