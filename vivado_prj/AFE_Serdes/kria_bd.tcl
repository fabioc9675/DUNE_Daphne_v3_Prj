...
fabian.castano:Dune:ADQ_DataFifo:1.0\
...
# Hierarchical cell: SlowControl
proc create_hier_cell_SlowControl { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_SlowControl() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 afe_gpio_ctrl

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 afe_pdn_rst_bus
  ...
  set pmod_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 pmod_2 ]
  set_property CONFIG.C_GPIO_WIDTH {2} $pmod_2


  # Create instance: rpi_gpio, and set properties
  set rpi_gpio [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 rpi_gpio ]
  set_property CONFIG.C_GPIO_WIDTH {1} $rpi_gpio
  ...
  connect_bd_intf_net -intf_net pmod_2_GPIO [get_bd_intf_pins afe_pdn_rst_bus] [get_bd_intf_pins pmod_2/GPIO]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins AXI_LITE] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins pmod_2/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins S_AXI2] [get_bd_intf_pins rpi_gpio/S_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins S_AXI1] [get_bd_intf_pins uf_leds/S_AXI]
  connect_bd_intf_net -intf_net rpi_gpio_GPIO [get_bd_intf_pins afe_gpio_ctrl] [get_bd_intf_pins rpi_gpio/GPIO]

  # Create port connections
  connect_bd_net -net axi_quad_spi_0_io0_o [get_bd_pins afe0_sdata] [get_bd_pins axi_quad_spi_0/io0_o]
  connect_bd_net -net axi_quad_spi_0_ip2intc_irpt [get_bd_pins ip2intc_irpt] [get_bd_pins axi_quad_spi_0/ip2intc_irpt]
  connect_bd_net -net axi_quad_spi_0_sck_o [get_bd_pins afe0_sclk] [get_bd_pins axi_quad_spi_0/sck_o]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins s_axi_aclk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins pmod_2/s_axi_aclk] [get_bd_pins rpi_gpio/s_axi_aclk] [get_bd_pins uf_leds/s_axi_aclk]
  connect_bd_net -net io1_i_0_1 [get_bd_pins afe0_sdout] [get_bd_pins axi_quad_spi_0/io1_i]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins pmod_2/s_axi_aresetn] [get_bd_pins rpi_gpio/s_axi_aresetn] [get_bd_pins uf_leds/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ext_spi_clk] [get_bd_pins axi_quad_spi_0/ext_spi_clk]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: Interrupt_Handler
proc create_hier_cell_Interrupt_Handler { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_Interrupt_Handler() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins axi_intc_0/s_axi]
  ...
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn]
...
proc create_hier_cell_Clock_Generator { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk clk_100M_PS
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_200M] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_20M] [get_bd_pins clk_wiz_0/clk_out3]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_100M_PS] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins resetn] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in]
...
proc create_hier_cell_Axi_DMA { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_Axi_DMA() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: ADQ_DataFifo_Sine, and set properties
  set ADQ_DataFifo_Sine [ create_bd_cell -type ip -vlnv fabian.castano:Dune:ADQ_DataFifo:1.0 ADQ_DataFifo_Sine ]

  # Create instance: axi_dma_sine, and set properties
  set axi_dma_sine [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_sine ]
  set_property -dict [list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ADQ_DataFifo_0_M00_AXIS [get_bd_intf_pins ADQ_DataFifo_Sine/M00_AXIS] [get_bd_intf_pins axi_dma_sine/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_dma_sine/M_AXI_S2MM]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_sine/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net Clock_Generator_clk_out3 [get_bd_pins clk_adc] [get_bd_pins ADQ_DataFifo_Sine/clk_adc]
  connect_bd_net -net axi_dma_afe_s2mm_introut [get_bd_pins s2mm_introut] [get_bd_pins axi_dma_sine/s2mm_introut]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins m00_axis_aclk] [get_bd_pins ADQ_DataFifo_Sine/m00_axis_aclk] [get_bd_pins axi_dma_sine/m_axi_s2mm_aclk] [get_bd_pins axi_dma_sine/s_axi_lite_aclk]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins m00_axis_aresetn] [get_bd_pins ADQ_DataFifo_Sine/m00_axis_aresetn] [get_bd_pins axi_dma_sine/axi_resetn]
  connect_bd_net -net sine_wave_gen_0_sine_out [get_bd_pins data_in] [get_bd_pins ADQ_DataFifo_Sine/data_in]
...
proc create_hier_cell_AXI_DMA_Real { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_AXI_DMA_Real() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: ADQ_DataFifo_AFE, and set properties
  set ADQ_DataFifo_AFE [ create_bd_cell -type ip -vlnv fabian.castano:Dune:ADQ_DataFifo:1.0 ADQ_DataFifo_AFE ]

  # Create instance: axi_dma_afe, and set properties
  set axi_dma_afe [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 axi_dma_afe ]
  set_property -dict [list \
    CONFIG.c_include_mm2s {0} \
    CONFIG.c_include_sg {0} \
    CONFIG.c_s2mm_burst_size {256} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net ADQ_DataFifo_AFE_M00_AXIS [get_bd_intf_pins ADQ_DataFifo_AFE/M00_AXIS] [get_bd_intf_pins axi_dma_afe/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXI_S2MM] [get_bd_intf_pins axi_dma_afe/M_AXI_S2MM]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI_LITE] [get_bd_intf_pins axi_dma_afe/S_AXI_LITE]

  # Create port connections
  connect_bd_net -net ADC_AFE_interface_0_dataOut [get_bd_pins data_in] [get_bd_pins ADQ_DataFifo_AFE/data_in]
  connect_bd_net -net ADC_AFE_interface_0_fclk_out [get_bd_pins clk_adc] [get_bd_pins ADQ_DataFifo_AFE/clk_adc]
  connect_bd_net -net axi_dma_afe_s2mm_introut1 [get_bd_pins s2mm_introut] [get_bd_pins axi_dma_afe/s2mm_introut]
  connect_bd_net -net m00_axis_aclk_1 [get_bd_pins m00_axis_aclk] [get_bd_pins ADQ_DataFifo_AFE/m00_axis_aclk] [get_bd_pins axi_dma_afe/m_axi_s2mm_aclk] [get_bd_pins axi_dma_afe/s_axi_lite_aclk]
  connect_bd_net -net m00_axis_aresetn_1 [get_bd_pins m00_axis_aresetn] [get_bd_pins ADQ_DataFifo_AFE/m00_axis_aresetn] [get_bd_pins axi_dma_afe/axi_resetn]
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set ADC_AFE_interface_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ADC_AFE_interface_0 eq "" } {
  ...
  # Create instance: Interrupt_Handler
  create_hier_cell_Interrupt_Handler [current_bd_instance .] Interrupt_Handler

  # Create instance: SlowControl
  create_hier_cell_SlowControl [current_bd_instance .] SlowControl
...
\
  ...
  connect_bd_intf_net -intf_net pmod_2_GPIO [get_bd_intf_ports afe_pdn_rst_bus] [get_bd_intf_pins SlowControl/afe_pdn_rst_bus]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins Interrupt_Handler/s_axi] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins SlowControl/AXI_LITE] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins SlowControl/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins SlowControl/S_AXI2] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net axi_intc_0_irq [get_bd_pins Interrupt_Handler/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins Clock_Generator/resetn] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0x80090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs SlowControl/rpi_gpio/S_AXI/Reg] -force
  ...
  set_property PFM.CLOCK {clk_out1 {id "0" is_default "false" proc_sys_reset "/Clock_Generator/proc_sys_reset_1" status "fixed" freq_hz "100000000"} clk_out2 {id "1" is_default "true" proc_sys_reset "/Clock_Generator/proc_sys_reset_2" status "fixed" freq_hz "200000000"}} [get_bd_cells /Clock_Generator/clk_wiz_0]
