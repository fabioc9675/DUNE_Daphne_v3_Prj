...
proc create_root_design { parentCell } {
  ...
  set kria_spi_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:spi_rtl:1.0 kria_spi_0 ]
...
\
  ...
  connect_bd_intf_net -intf_net axi_quad_spi_0_SPI_0 [get_bd_intf_ports kria_spi_0] [get_bd_intf_pins axi_quad_spi_0/SPI_0]
  connect_bd_intf_net -intf_net axi_quad_spi_1_SPI_0 [get_bd_intf_ports kria_spi_1] [get_bd_intf_pins axi_quad_spi_1/SPI_0]
  ...
  set_property PFM_NAME {xilinx:kr260_som_som240_1_connector_kr260_carrier_som240_1_connector_som240_2_connector_kr260_carrier_som240_2_connector:kr260_daphne_bd:0.0} [get_files [current_bd_design].bd]
